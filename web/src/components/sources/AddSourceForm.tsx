...
export function AddSourceForm({ onCreated }: AddSourceFormProps) {
  ...
  const hostError =
    isCreatingHost && !isHostless
      ? validateHostConfig(type as Exclude<SourceType, "local" | "paperless" | "immich" | "azureblob">, hostConfig)
      : null;
          ...
          <div className="rounded-md border border-line p-3 bg-app space-y-3">
            ...
            {isCreatingHost && (
              <div className="pt-2 border-t border-line">
                ...
                <HostFields
                  type={type as Exclude<SourceType, "local" | "paperless" | "immich" | "azureblob">}
                  value={hostConfig}
