 ...
 */
export function HostFields({ type, value, onChange }: Props): ReactNode {
  switch (type) {
    case "ssh":
      return <SshHostFields value={value as Partial<SshConfig>} onChange={onChange} />;
    case "smb":
      return <SmbHostFields value={value as Partial<SmbConfig>} onChange={onChange} />;
    case "nfs":
      return <NfsHostFields value={value as Partial<NfsConfig>} onChange={onChange} />;
    case "s3":
      return <S3HostFields value={value as Partial<S3Config>} onChange={onChange} />;
  }
}
